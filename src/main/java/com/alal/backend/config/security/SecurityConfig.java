package com.alal.backend.config.security;


import com.alal.backend.config.security.handler.CustomSimpleUrlAuthenticationFailureHandler;
import com.alal.backend.config.security.handler.CustomSimpleUrlAuthenticationSuccessHandler;
import com.alal.backend.config.security.token.CustomAuthenticationEntryPoint;
import com.alal.backend.config.security.token.CustomOncePerRequestFilter;
import com.alal.backend.repository.auth.CustomAuthorizationRequestRepository;
import com.alal.backend.service.auth.CustomDefaultOAuth2UserService;
import com.alal.backend.service.auth.CustomUserDetailsService;
